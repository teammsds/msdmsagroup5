...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8 wow bounceInRight">
           ...
           <a style= "color: white;text-shadow: 2px 2px 4px #000000" href="{{ action('MatchController@index')}}" class="glow"><h2>Visit ongoing matches</h2></a>
           <br>
           <br>
           <i class="fa fa-futbol-o" style="font-size: 40px;color:Green"></i>
           <a style= "color: white;text-shadow: 2px 2px 4px #000000" href="{{ action('TournamentController@index')}}" class="glow"><h2>Tournament List</h2></a>
             </div>
